...
typedef CGAL::Shape_detection::Shape_detection_traits<Kernel, Pwn_vector, Point_map, Normal_map> Traits;
typedef CGAL::Shape_detection::Efficient_RANSAC<Traits> Efficient_ransac;
typedef CGAL::Shape_detection::Region_growing<Traits>   Region_growing;
...
int run(const char* filename)
{
	...
	shape_detection.detect(typename ShapeDetection::Parameters(), timeout_callback);
