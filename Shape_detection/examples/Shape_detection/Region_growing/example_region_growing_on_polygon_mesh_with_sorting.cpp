...
#define USE_SURFACE_MESH
    ...
    using Sorting      = SD::Polygon_mesh_least_squares_plane_fit_sorting<Kernel, Polygon_mesh, Connectivity, Face_range>;

#endif

using Region_growing = SD::Region_growing<Face_range, Connectivity, Conditions, Sorting::Seed_map>;

int main(int argc, char *argv[]) {

  std::cout << std::endl << 
    "region_growing_on_polygon_mesh_with_sorting example started" 
  << std::endl << std::endl;
  ...
  Region_growing region_growing(face_range, connectivity, conditions, sorting.seed_map());
  ...
  std::cout << std::endl << 
    "region_growing_on_polygon_mesh_with_sorting example finished" 
  << std::endl << std::endl;
