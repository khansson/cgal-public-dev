...
using Sorting        = CGAL::Shape_detection::Points_2_least_squares_line_fit_sorting<Kernel, Input_range, Connectivity, Point_map>;
using Region_growing = CGAL::Shape_detection::Region_growing<Input_range, Connectivity, Conditions, typename Sorting::Seed_map>;
