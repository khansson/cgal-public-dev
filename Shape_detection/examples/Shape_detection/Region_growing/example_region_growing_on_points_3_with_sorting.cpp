...
using Sorting        = SD::Points_3_least_squares_plane_fit_sorting<Kernel, Input_range, Point_map, Connectivity>;
using Region_growing = SD::Region_growing<Input_range, Connectivity, Conditions, Sorting::Seed_map>;
...
int main(int argc, char *argv[]) {
  ...
  std::cout << std::endl << 
    "region_growing_on_points_3_with_sorting example started" 
  << std::endl << std::endl;
  ...
  std::cout << std::endl << 
    "region_growing_on_points_3_with_sorting example finished" 
  << std::endl << std::endl;
