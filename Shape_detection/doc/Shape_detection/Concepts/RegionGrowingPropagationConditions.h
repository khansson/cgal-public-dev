...
\cgalHasModel `CGAL::Shape_detection::Propagation_conditions_on_points_2` `CGAL::Shape_detection::Propagation_conditions_on_points_3` `CGAL::Shape_detection::Propagation_conditions_on_face_graph`
*/
...
public:
    ...
    /// A local condition that checks if an item with the index `query_index` belongs to a `region`, where `Index` is any signed integer and `Region` is a random access container with indices of other items.
