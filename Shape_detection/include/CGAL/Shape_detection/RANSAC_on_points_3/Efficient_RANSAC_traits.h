...
#ifndef CGAL_SHAPE_DETECTION_RANSAC_ON_POINTS_3_EFFICIENT_RANSAC_TRAITS_H
#define CGAL_SHAPE_DETECTION_RANSAC_ON_POINTS_3_EFFICIENT_RANSAC_TRAITS_H
...
namespace CGAL {
	...
	/*!
		...
		\tparam InputRange is a model of `Range` with random access iterators, providing input points and normals through the following two property maps.
...
#endif // CGAL_SHAPE_DETECTION_RANSAC_ON_POINTS_3_EFFICIENT_RANSAC_TRAITS_H
