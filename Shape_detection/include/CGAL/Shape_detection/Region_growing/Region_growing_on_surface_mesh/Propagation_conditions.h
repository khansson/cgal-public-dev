                ...
                void update_shape(const Region_& region) {
                    ...
                    if (region.size() == 1) {
                        ...
                        // Fit the region to a plane
                            ...
                            linear_least_squares_fitting_3(points.begin(), points.end(), m_plane_of_best_fit, centroid, CGAL::Dimension_tag<0>(), Local_kernel(), Default_diagonalize_traits<typename Local_kernel::FT, 3>());
                        #else 
                            linear_least_squares_fitting_3(points.begin(), points.end(), m_plane_of_best_fit, centroid, CGAL::Dimension_tag<0>(), Local_kernel(), Eigen_diagonalize_traits<typename Local_kernel::FT, 3>());
                        #endif
