...
#ifndef CGAL_SHAPE_DETECTION_RANSAC_ON_POINTS_3_SPHERE_H
#define CGAL_SHAPE_DETECTION_RANSAC_ON_POINTS_3_SPHERE_H
...
namespace CGAL {
	...
	/*!
		...
		\tparam Traits a model of `EfficientRANSACTraits` with the additional requirement for spheres (see `EfficientRANSACTraits` documentation).
	*/
...
#endif // CGAL_SHAPE_DETECTION_RANSAC_ON_POINTS_3_SPHERE_H
