...
#ifndef CGAL_SHAPE_DETECTION_RANSAC_ON_POINTS_3_PLANE_H
#define CGAL_SHAPE_DETECTION_RANSAC_ON_POINTS_3_PLANE_H
...
namespace CGAL {
	...
	/*!
		...
		\tparam Traits a model of `EfficientRANSACTraits` with the additional requirement for planes (see `EfficientRANSACTraits` documentation).
	*/
...
#endif // CGAL_SHAPE_DETECTION_RANSAC_ON_POINTS_3_PLANE_H
