...
#ifndef CGAL_SHAPE_DETECTION_3_EFFICIENT_RANSAC_TRAITS_COMPILATION_TEST_H
#define CGAL_SHAPE_DETECTION_3_EFFICIENT_RANSAC_TRAITS_COMPILATION_TEST_H
...
namespace CGAL {
	...
	struct Shape_detection_traits {
		...
		typedef Shape_detection_traits<Gt, InputRange, InputPointMap, InputNormalMap> Self;
		///
		typedef double FT;
...
#endif // CGAL_SHAPE_DETECTION_3_EFFICIENT_RANSAC_TRAITS_COMPILATION_TEST_H
